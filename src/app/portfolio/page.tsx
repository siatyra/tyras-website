  ...
  return (
    <div className="flex flex-col justify-start gap-5">
      <div className="flex flex-col justify-start gap-5">
        ...
        <H2>
          This should be bulked out a little more as the year goes on! For now
          you might enjoy my first project - an app I made as part of the Black
          CodHer software development bootcamp. It is a simple app that pulls
          Doja Cats tweets from Twitter and displays them in a fun way. It is no
          longer deployed but I have the relevant links below. Enjoy!
        </H2>
